...
Page({
  ...
  //初始化
  _init: function () {
    let NextSong = app.songlist[app.currentIndex] || (songslist && songslist[app.currentIndex])
  ...
  //上一首
  lastMusic: function () {
    let currentIndex = this.data.currentIndex > 0 ? this.data.currentIndex - 1 : this.data.songslist.length - 1;
    this.setData({
  ...
  //下一首
  nextMusic: function () {
    let currentIndex = this.data.currentIndex < this.data.songslist.length - 1 ? this.data.currentIndex + 1 : 0;
